...
INSERT INTO `Screening` (`screening_time`, `remain_quantity`, `price`, `movie_id`, `room_id`)
VALUES
    ('2025-10-09 09:00:00', 200,  16000, 1, 1), -- s1: movie_id=1, room_id=1
    ('2025-10-09 09:10:00', 150,20000, 1, 2), -- s2: movie_id=1, room_id=2
    ('2025-10-09 12:30:00', 200, 16000,3, 1), -- s3: movie_id=3, room_id=1
    ('2025-10-10 09:00:00', 200, 16000,2, 3); -- s4: movie_id=2, room_id=3
